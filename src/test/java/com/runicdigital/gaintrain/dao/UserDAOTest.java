...
public class UserDAOTest {
    ...
    public void testQueryUserById() throws SQLException {
        ...
        User user0_1 = userDAO.findUserById(Long.valueOf(1));
        User user1_1 = userDAO.findUserById(Long.valueOf(2));
    ...
    public void testQueryUserByEmail() throws SQLException {
        ...
        User user0_1 = userDAO.findUserByEmail("testuser@test.com");
        User user1_1 = userDAO.findUserByEmail("aaa@test.com");
    ...
    public void testUpdateUser() throws SQLException {
        ...
        User user1 = userDAO.findUserById(Long.valueOf(1));
